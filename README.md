...
- 필자의 경우, GitHub 주소를 옮긴 관계로, Commit 내역의 **20190942**, **hello** 계정이 본인임을 밝힙니다. 
 
- 해당 README.md 파일은 전반적인 프로젝트의 정보를 **글**로 기재하였습니다. **요구사항 분석**, **use-case model**, **시스템 구성도**, **UI 설계**, **Domain**, **Database**, **Request Mapping**, **프로그램 동작 화면** 등이 포함된 **이미지 파일**을 확인 하시려면 아래 첨부된 **pdf 파일 및 mp3 파일 공유 링크를 확인해주시면** 감사하겠습니다.
